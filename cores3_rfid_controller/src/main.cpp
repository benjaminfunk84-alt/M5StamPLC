...
// CONSTANTS
// ============================================
const unsigned long STATUS_SEND_INTERVAL_MS = 500;   // UDP-Status alle 500ms
...
void setupWiFiAP() {
  ...
  Serial.println("UDP OK (Status:4211 Cmd:4210)");
}
...
void sendStatusUdp() {
  ...
  // Broadcast an alle im SoftAP-Netz (192.168.4.255)
